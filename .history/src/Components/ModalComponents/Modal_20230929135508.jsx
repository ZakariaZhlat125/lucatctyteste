...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-50">
      ...
      <div className="bg-white w-[40rem] h-[36rem]  rounded-lg p-8 z-50 relative flex flex-col justify-between items-center">
      <FontAwesomeIcon
          icon={faTimes}
          onClick={onClose}
          className="w-12 h-12 self-end cursor-pointer" />
        {currentPage === 1 && (
          <Welcom
