...
const Modal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-50">
      ...
      <div className="bg-white sm:w-[40rem] w-[90vw] sm:h-[36rem] mx-1 max-h-max rounded-lg p-8 z-50 relative flex flex-col justify-between items-center overflow-y-auto">
      <FontAwesomeIcon
          icon={faTimes}
          onClick={onClose}
        ...
        {currentPage === 3 && <SelectImage selectedItems={selectedItems}  setSelectedItems={setSelectedItems}/>}
