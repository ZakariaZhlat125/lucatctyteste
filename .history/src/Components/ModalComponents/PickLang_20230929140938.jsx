  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mb-4 my-2">
        <select
          id="languageSelect"
          className="sm:w-[10rem] w-[70vw] px-3 py-2 border outline-none text-zinc-400 bg-neutral-100 rounded-lg"
      ...
      <div className="my-2">
        <select
          id="countrySelect"
          className="sm:w-full w-[70vw]  px-3 py-2 border outline-none text-zinc-400 bg-neutral-100 rounded-lg"
