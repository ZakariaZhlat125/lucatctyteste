    ...
    <div className="flex flex-col justify-center items-center px-32">
      ...
      <div className="relative mt-4">
        <input
          ...
          className="py-2 px-8 pr-12 border rounded focus:outline-none focus:border-orange-500"
        />
        <FontAwesomeIcon
          icon={faPencilAlt}
          className="absolute right-2 top-2 text-slate-600 w-6 h-6 cursor-pointer"
        />
      </div>
