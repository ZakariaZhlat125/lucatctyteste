...
const Welcom = ({ inputValueName, setInputValueName }) => {
    ...
    <div className="flex flex-col justify-center items-center px-32">
      ...
      <div className="relative mt-4">
        <input
          ...
          className=" sm:w-[20rem] w-[70vw] py-2 px-8 pr-12 border text-orange-500 font-bold text-[18px] bg-neutral-100 rounded-lg focus:outline-none focus:border-orange-500"
          value={inputValueName} // Bind input value to state
